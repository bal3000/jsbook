...
function createCellsRouter(filename, dir) {
    ...
    router.get('/cells', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var file, err_1;
    ...
    router.post('/cells', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var cells, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fs_1.promises.writeFile(fullPath, data, 'utf-8')];
                case 1:
                    _a.sent();
                    res.send({ status: 'ok' });
                    return [2 /*return*/];
